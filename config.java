...
public class config extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtPhone, javax.swing.GroupLayout.DEFAULT_SIZE, 70, Short.MAX_VALUE))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        try {
            String sql ="UPDATE mhs SET nama = '"+txtNama.getText()+
                    "', nim = '"+txtNim.getText()+"', jurusan = '"+jComboBox1.getSelectedItem()+
                    "',alamat= '"+ txtAlamat.getText()+"', phone= '"
                    +txtPhone.getText()+"'WHERE nim = '"+txtNim.getText()+"'";
            java.sql.Connection conn=(Connection)config.configDB();
            java.sql.PreparedStatement pst =conn.prepareStatement(sql);
            pst.execute();
